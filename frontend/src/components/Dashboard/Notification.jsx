                ...
                {notifications.length === 0 ? (
                    ...
                    <div className='space-y-3'>
                        {notifications.map((notification) => (
                            <div key={notification.id} className={`p-4 bg-white shadow rounded-2xl border-solid border-2 hover:shadow-lg transition duration-300 ${notification.bgColor} ${notification.borderColor} bg-opacity-60 cursor-pointer`} onClick={() => setSelectedNotification(notification)}>
